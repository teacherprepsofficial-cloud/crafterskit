    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border-2 border-dashed border-[#e11d48]/30 rounded-3xl p-5 sm:p-8 hover:border-[#e11d48]/60 hover:shadow-md transition-all duration-200">
        ...
        <textarea
          ...
          className="w-full border-2 border-dashed border-[#e11d48]/20 hover:border-[#e11d48]/40 focus:border-[#e11d48] focus:border-solid focus:ring-4 focus:ring-[#e11d48]/10 rounded-2xl px-5 py-4 text-lg text-gray-900 focus:outline-none resize-y transition-all duration-200 leading-relaxed placeholder:text-gray-400"
        />
      </div>
